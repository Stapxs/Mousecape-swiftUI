...
<br>
<details>
<summary>创建自定义光标/ 导入 Windows 格式光标</summary>
...
<br>
<details>
<summary>导入/导出 .cape 格式光标（分享用）</summary>
...
<br>
<details>
<summary>光标修改仅在 Mousecape 应用内 / Dock 区域生效</summary>

**症状**：光标修改在 Mousecape 应用内 / Dock 区域时才生效，移动到其他地方会恢复为系统默认光标。
