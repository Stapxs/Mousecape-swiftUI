...
- **热点编辑升级** — 更直观地调整热点位置
  - 直接在预览窗口中拖拽热点
  - 全新玻璃滑块精确定位，支持一键居中
- **光标动静态切换** — 每个光标主题可独立切换动画/静态显示
  - 切换为静态后，应用光标时使用静态首帧
- **动画光标播放速度编辑** — 调整动画光标的播放速度
  - 速度滑块（0.5×~3×），拖动时预览实时生效

**改进：**

- 设置页面全面采用液态玻璃设计，与应用其他界面风格统一
- 光标缩放与系统辅助功能设置同步，应用更可靠
- 改进与 macOS 27 测试版的兼容性
- 现在支持 macOS 14 及以上版本
...
- 修复 .ani 动画光标转换模糊的问题 — 导入的 Windows 动画光标现在清晰锐利
- 增加更多 INF 文件格式支持，提升 Windows 光标主题兼容性
